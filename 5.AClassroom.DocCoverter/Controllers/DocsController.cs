...
using System.Web;
using _5.AClassroom.DocCoverter.Models;
using AClassroom.Entity.Enum;

namespace _5.AClassroom.DocCoverter.Controllers
{
    public class DocsController : ApiController
    {
        ...
        /// <returns></returns>
        [HttpPost]
        public CommonResult<Document> Upload(string fileMd5, DocmentOnwerTypeEnum onwerType, UploadClientTypeEnum clientType)
        {
            var result = new CommonResult<Document>();
            try
            {
        ...
        /// <returns></returns>
        [HttpGet]
        public CommonResult<Document> GetDocument(string fileMd5)
        {
            var result = new CommonResult<Document>();
